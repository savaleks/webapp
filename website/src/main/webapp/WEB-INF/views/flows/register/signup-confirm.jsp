...
<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="panel panel-warning">
							...
							<div class="panel-footer">
								<a href="${flowExecutionUrl}&_eventId_personal" class="btn btn-primary btn-md">Edit</a>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="panel panel-warning">
							...
							<div class="panel-body">
								<div class="text-center">
									<h4>${registerModel.billing.addressLine}. ${registerModel.billing.addressNumber}</h4>
							...
							<div class="panel-footer">
								<a href="${flowExecutionUrl}&_eventId_billing" class="btn btn-primary btn-md">Edit</a>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-4 col-sm-offset-4">
						<div class="text-center">
							<a href="${flowExecutionUrl}&_eventId_submit" class="btn btn-primary btn-lg">Confirm</a>
						</div>
					</div>
