...
values ('Laptops', 'Description for laptop', 'img1.png', true);
insert into category (name, description, image_url, is_active)
values ('Smaptphones', 'Description for smartphones', 'img2.png', true);
insert into category (name, description, image_url, is_active)
values ('Headphones', 'Description for headphones', 'img3.png', true);
insert into category (name, description, image_url, is_active)
values ('TV', 'Description for tv', 'img4.png', true);
insert into category (name, description, image_url, is_active)
values ('Cameras', 'Description for cameras', 'img5.png', true);
insert into category (name, description, image_url, is_active)
values ('GPS', 'Description for gps', 'img6.png', true);

-- adding three users 
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Alex', 'Sky', 'ADMIN', true, '$2a$06$ORtBskA2g5Wg0HDgRE5ZsOQNDHUZSdpJqJ2.PGXv0mKyEvLnKP7SW', 'alex@gmail.com', '8888888888');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Jonas', 'Jonaitis', 'SUPPLIER', true, '$2a$06$bzYMivkRjSxTK2LPD8W4te6jjJa795OwJR1Of5n95myFsu3hgUnm6', 'jonas@gmail.com', '9999999999');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Petras', 'Petraitis', 'SUPPLIER', true, '$2a$06$i1dLNlXj2uY.UBIb9kUcAOxCigGHUZRKBtpRlmNtL5xtgD6bcVNOK', 'petras@gmail.com', '7777777777');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Tom', 'Smith', 'USER', true, '$2a$06$4mvvyO0h7vnUiKV57IW3oudNEaKPpH1xVSdbie1k6Ni2jfjwwminq', 'tom@gmail.com', '7777777777');
...
VALUES (4, 'Vilniaus g.2-34', 'Naujamiestis', 'Vilnius', '', 'Lietuva', '111111', true, false );
